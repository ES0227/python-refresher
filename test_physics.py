...
class testPhysics(unittest.TestCase):
    ...
    def test_torque_calculator(self):
        self.assertAlmostEqual(
            physics.calculate_torque(5, 45, 7), 24.748737341529157
        )  # np.sin(np.radians(45)*35))
        with self.assertRaises(ValueError):
    ...
    def test_auvAcceleration_calculator(self):
        # self.assertAlmostEqual(
        #     physics.calculate_auv_acceleration(5, 30, 100, 0.1, 0.5),
        #     np.array([[0.216506], [0.125]])
        # )
    ...
    def test_auvAngularAcceleration_calculator(self):
        self.assertAlmostEqual(
            physics.calculate_auv_angular_acceleration(5, 30, 1, 1), 2.5
        )
        with self.assertRaises(ValueError):
            (physics.calculate_auv_angular_acceleration(-5, 30, 1, -5))

    def 
    
    #def test_auv2Angular
